...
const PostStats = ({ post, user_id }: PostStatsProps) => {
  ...
  const { mutate: deleteSavePost, isPending: isUnsavingPost } =
    useDeleteSavedPost();
  ...
  const handleLikePost = (
    ...
    setLikes(likesArray);
    likePost({ post_id: post.$id, likesArray });
  };
  ...
  const handleSavePost = (
    ...
    savePost({ user_id: user_id, post_id: post.$id });
    setIsSaved(true);
  };
